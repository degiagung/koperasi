...
function(L) {
    ...
    L.esri.Util.extentToBounds = function(a) {
        ...
        var d = {};
        return "number" == typeof b.x && "number" == typeof b.y && (d.type = "Point", d.coordinates = [b.x, b.y]), b.points && (d.type = "MultiPoint", d.coordinates = b.points.slice(0)), b.paths && (1 === b.paths.length ? (d.type = "LineString", d.coordinates = b.paths[0].slice(0)) : (d.type = "MultiLineString", d.coordinates = b.paths.slice(0))), b.rings && (d = i(b.rings.slice(0))), (b.geometry || b.attributes) && (d.type = "Feature", d.geometry = b.geometry ? L.esri.Util.arcgisToGeojson(b.geometry) : null, d.properties = b.attributes ? a(b.attributes) : null, b.attributes && (d.id = b.attributes[c] || b.attributes.OBJECTID || b.attributes.FID)), d
        ...
        switch (b.type) {
            case "Point":
                f.x = b.coordinates[0], f.y = b.coordinates[1], f.spatialReference = e;
                break;
            case "MultiPoint":
            ...
            case "MultiPolygon":
                ...
                break;
            case "Feature":
                b.geometry && (f.geometry = L.esri.Util.geojsonToArcGIS(b.geometry, c)), f.attributes = b.properties ? a(b.properties) : {}, b.id && (f.attributes[c] = b.id);
                break;
            case "FeatureCollection":
                for (f = [], d = 0; d < b.features.length; d++) f.push(L.esri.Util.geojsonToArcGIS(b.features[d], c));
                break;
            case "GeometryCollection":
                for (f = [], d = 0; d < b.geometries.length; d++) f.push(L.esri.Util.geojsonToArcGIS(b.geometries[d], c))
        }
        return f
        ...
        if (f.length)
            for (var g = f.length - 1; g >= 0; g--) e.features.push(L.esri.Util.arcgisToGeojson(f[g], c));
        return e
    }, L.esri.Util.cleanUrl = function(a) {
        return a = a.replace(/\s\s*/g, ""), "/" !== a[a.length - 1] && (a += "/"), a
    }
}(L),
function(L) {
    function a(a) {
        ...
        for (var c in a)
            if (a.hasOwnProperty(c)) {
                ...
                b.length && (b += "&"), d = "[object Array]" === f || "[object Object]" === f ? JSON.stringify(e) : "[object Date]" === f ? e.valueOf() : e, b += encodeURIComponent(c) + "=" + encodeURIComponent(d)
            } return b
    }
    ...
    L.esri.Request = {
        post: {
            XMLHTTP: function(c, d, e, f) {
                var g = b(e, f);
                return g.open("POST", c), g.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), g.send(a(d)), g
            }
        },
        get: {
            ...
            JSONP: function(b, d, e, f) {
                ...
                return h.type = "text/javascript", h.src = b + "?" + a(d), h.id = g, L.esri._callback[g] = function(a) {
                    if (L.esri._callback[g] !== !0) {
                        ...
                        }, a = null), !b && a.error && (b = a, a = null), e.call(f, b, a), L.esri._callback[g] = !0
                    }
                }, c++, L.esri._callback[g]
            }
        }
    }, L.esri.get = L.esri.Support.CORS ? L.esri.Request.get.CORS : L.esri.Request.get.JSONP, L.esri.post = L.esri.Request.post.XMLHTTP
}(L), L.esri.Services.Service = L.Class.extend({
    ...
    initialize: function(a, b) {
        this.url = L.esri.Util.cleanUrl(a), this._requestQueue = [], this._authenticating = !1, b = L.Util.setOptions(this, b)
    },
    ...
    _request: function(a, b, c, d, e) {
        ...
        if (this.options.token && (c.token = this.options.token), !this._authenticating) {
            ...
            return "get" !== a || this.options.useCors ? L.esri[a](g, c, f) : L.esri.Request.get.JSONP(g, c, f)
        }
    ...
    addFeature: function(a, b, c) {
        return delete a.id, a = L.esri.Util.geojsonToArcGIS(a), this.post("addFeatures", {
            features: [a]
        }, function(a, c) {
    ...
    updateFeature: function(a, b, c) {
        return a = L.esri.Util.geojsonToArcGIS(a, this.options.idAttribute), this.post("updateFeatures", {
            features: [a]
        }, function(a, d) {
    ...
    initialize: function(a) {
        a.url && a.get ? (this._service = a, this.url = a.url) : this.url = L.esri.Util.cleanUrl(a), this._params = {
            sr: 4326,
            layers: "all",
            tolerance: 3
        }
    ...
    on: function(a) {
        var b = L.esri.Util.boundsToExtent(a.getBounds()),
            c = a.getSize();
        return this._params.imageDisplay = [c.x, c.y, 96].join(","), this._params.mapExtent = [b.xmin, b.ymin, b.xmax, b.ymax].join(","), this
    },
    at: function(a) {
        return this._params.geometry = [a.lng, a.lat].join(","), this._params.geometryType = "esriGeometryPoint", this
    },
    layerDef: function(a, b) {
        return this._params.layerDefs = this._params.layerDefs ? this._params.layerDefs + ";" : "", this._params.layerDefs += [a, b].join(":"), this
    },
    ...
    simplify: function(a, b) {
        ...
        return this._params.maxAllowableOffset = c / a.getSize().y * (1 - b), this
    },
    token: function(a) {
    ...
    _request: function(a, b) {
        this._service ? this._service.get("identify", this._params, a, b) : L.esri.get(this.url + "identify", this._params, a, b)
    }
    ...
    within: function(a) {
        return this._params.geometry = L.esri.Util.boundsToExtent(a), this._params.geometryType = "esriGeometryEnvelope", this._params.spatialRel = "esriSpatialRelIntersects", this
    },
    nearby: function(a, b) {
        return this._params.geometry = [a.lng, a.lat].join(","), this._params.geometryType = "esriGeometryPoint", this._params.spatialRel = "esriSpatialRelIntersects", this._params.units = "esriSRUnit_Meter", this._params.distance = b, this._params.inSr = 4326, this
    },
    where: function(a) {
    ...
    orderBy: function(a, b) {
        return b = b || "ASC", this._params.orderByFields = this._params.orderByFields ? this._params.orderByFields + "," : "", this._params.orderByFields += [a, b].join(" "), this
    },
    ...
    run: function(a, b) {
        return this._cleanParams(), this._request(function(c, d) {
            a.call(b, c, d && L.esri.Util.responseToFeatureCollection(d), d)
        }, b), this
    },
    count: function(a, b) {
        return this._cleanParams(), this._params.returnCountOnly = !0, this._request(function(b, c) {
            a.call(this, b, c && c.count, c)
        }, b), this
    },
    ids: function(a, b) {
        return this._cleanParams(), this._params.returnIdsOnly = !0, this._request(function(b, c) {
            a.call(this, b, c && c.objectIds, c)
        }, b), this
    },
    bounds: function(a, b) {
        return this._cleanParams(), this._params.returnExtentOnly = !0, this._request(function(c, d) {
            a.call(b, c, d && d.extent && L.esri.Util.extentToBounds(d.extent), d)
        }, b), this
    },
    _cleanParams: function() {
        delete this._params.returnIdsOnly, delete this._params.returnExtentOnly, delete this._params.returnCountOnly
    },
    _request: function(a, b) {
        this._service ? this._service.get("query", this._params, a, b) : L.esri.get(this.url + "query", this._params, a, b)
    }
...
function(L) {
    ...
    L.esri.Layers.BasemapLayer = L.TileLayer.extend({
        statics: {
            TILES: {
                ...
                Oceans: {
                    urlTemplate: a + "//{s}.arcgisonline.com/arcgis/rest/services/Ocean/World_Ocean_Base/MapServer/tile/{z}/{y}/{x}",
                ...
                OceansLabels: {
                    urlTemplate: a + "//{s}.arcgisonline.com/arcgis/rest/services/Ocean/World_Ocean_Reference/MapServer/tile/{z}/{y}/{x}",
                    options: {
                        minZoom: 1,
                        maxZoom: 16,
                        subdomains: ["server", "services"]
                ...
                NationalGeographic: {
                    urlTemplate: a + "//{s}.arcgisonline.com/ArcGIS/rest/services/NatGeo_World_Map/MapServer/tile/{z}/{y}/{x}",
                    options: {
                        minZoom: 1,
                        maxZoom: 16,
                        subdomains: ["server", "services"],
        ...
        initialize: function(a, b) {
            ...
            if ("object" == typeof a && a.urlTemplate && a.options) c = a;
                ...
                if ("string" != typeof a || !L.esri.BasemapLayer.TILES[a]) throw new Error('L.esri.BasemapLayer: Invalid parameter. Use one of "Streets", "Topographic", "Oceans", "OceansLabels", "NationalGeographic", "Gray", "GrayLabels", "DarkGray", "DarkGrayLabels", "Imagery", "ImageryLabels", "ImageryTransportation", "ShadedRelief", "ShadedReliefLabels", "Terrain" or "TerrainLabels"');
                c = L.esri.BasemapLayer.TILES[a]
            }
            var d = L.Util.extend(c.options, b);
            L.TileLayer.prototype.initialize.call(this, c.urlTemplate, L.Util.setOptions(this, d)), c.attributionUrl && this._getAttributionData(c.attributionUrl)
        },
        onAdd: function(a) {
            L.TileLayer.prototype.onAdd.call(this, a), a.on("moveend", this._updateMapAttribution, this)
        },
        onRemove: function(a) {
            L.TileLayer.prototype.onRemove.call(this, a), a.off("moveend", this._updateMapAttribution, this)
        },
        getAttribution: function() {
            var a = '<a href="https://developers.arcgis.com"><img src="http://js.arcgis.com/3.9/js/esri/images/map/logo-med.png" style="position:absolute; top:-38px; right:2px;"></a>',
                b = '<span class="esri-attributions" style="line-height:14px; vertical-align: -3px; text-overflow:ellipsis; white-space:nowrap; overflow:hidden; display:inline-block;">' + this.options.attribution + "</span>" + a;
            return b
        },
        _getAttributionData: function(a) {
            L.esri.get(a, {}, function(a, b) {
                this._attributions = [];
    ...
    }), L.esri.BasemapLayer = L.esri.Layers.BasemapLayer, L.esri.Layers.basemapLayer = function(a, b) {
        return new L.esri.Layers.BasemapLayer(a, b)
    }, L.esri.basemapLayer = function(a, b) {
        return new L.esri.Layers.BasemapLayer(a, b)
    }
}(L), L.esri.Layers.DynamicMapLayer = L.Class.extend({
    includes: L.Mixin.Events,
    options: {
        opacity: 1,
        position: "front",
    ...
    initialize: function(a, b) {
        this.url = L.esri.Util.cleanUrl(a), this._service = new L.esri.Services.MapService(this.url, b), this._service.on("authenticationrequired requeststart requestend requesterror requestsuccess", this._propagateEvent, this), L.Util.setOptions(this, b)
    },
    onAdd: function(a) {
        ...
        this._popup && (this._map.on("click", this._getPopupData, this), this._map.on("dblclick", this._resetPopupState, this)), this._map.addEventListener(this.getEvents(), this), this._update()
    },
    onRemove: function() {
        this._currentImage && this._map.removeLayer(this._currentImage), this._popup && (this._map.off("click", this._getPopupData, this), this._map.off("dblclick", this._resetPopupState, this)), this._map.removeEventListener(this.getEvents(), this)
    },
    addTo: function(a) {
    ...
    _getPopupData: function(a) {
        ...
        this.options.layers && c.layers("visible:" + this.options.layers.join(",")), c.run(b), this._shouldRenderPopup = !0, this._lastClick = a.latlng
    },
    ...
    _buildExportParams: function() {
        ...
        return this.options.layers && (e.layers = "show:" + this.options.layers.join(",")), this.options.layerDefs && (e.layerDefs = JSON.stringify(this.options.layerDefs)), this.options.timeOptions && (e.timeOptions = JSON.stringify(this.options.timeOptions)), this.options.from && this.options.to && (e.time = this.options.from.valueOf() + "," + this.options.to.valueOf()), this._service.options.token && (e.token = this._service.options.token), e
    },
    _renderImage: function(a, b) {
        ...
        c.once("load", function(a) {
            ...
            c._bounds.equals(b) ? (this._currentImage = c, "front" === this.options.position ? this.bringToFront() : this.bringToBack(), this._currentImage.setOpacity(this.options.opacity), d && this._map.removeLayer(d)) : this._map.removeLayer(c), this.fire("load", {
                bounds: b
            })
    ...
    _update: function() {
        if (this._map) {
            ...
            if (!this._animatingZoom && !(this._map._panTransition && this._map._panTransition._inProgress || a > this.options.maxZoom || a < this.options.minZoom)) {
                ...
                "json" === this.options.f ? this._service.get("export", c, function(a, c) {
                    this._renderImage(c.href, b)
                }, this) : (c.f = "image", this._renderImage(this.url + "export" + L.Util.getParamString(c), b))
            }
        }
    },
...
}), L.esri.DynamicMapLayer = L.esri.Layers.DynamicMapLayer, L.esri.Layers.dynamicMapLayer = function(a, b) {
...
}), L.esri.TiledMapLayer = L.esri.Layers.tiledMapLayer, L.esri.Layers.tiledMapLayer = function(a, b) {
...
function(L) {
    ...
    L.esri.Layers.FeatureManager = L.esri.Layers.FeatureGrid.extend({
        ...
        initialize: function(b, c) {
            L.esri.Layers.FeatureGrid.prototype.initialize.call(this, c), c = L.setOptions(this, c), this.url = L.esri.Util.cleanUrl(b), this._service = new L.esri.Services.FeatureLayer(this.url, c), this._service.on("authenticationrequired requeststart requestend requesterror requestsuccess", function(a) {
                a = L.extend({
                    target: this
                }, a), this.fire(a.type, a)
            }, this), this.options.timeField.start && this.options.timeField.end ? (this._startTimeIndex = new a, this._endTimeIndex = new a) : this.options.timeField && (this._timeIndex = new a), this._cache = {}, this._currentSnapshot = [], this._activeRequests = 0
        },
        onAdd: function(a) {
        ...
        _requestFeatures: function(a, b, c) {
            this._activeRequests++, 1 === this._activeRequests && this.fire("loading", {
                ...
                f && f.exceededTransferLimit && this.fire("drawlimitexceeded"), this._activeRequests--, !d && e.features.length && this._addFeatures(e.features, b), c && c.call(this, d, e), this._activeRequests <= 0 && this.fire("load", {
                    bounds: a
                })
            }, this)
        },
        _addFeatures: function(a, b) {
            ...
            this.options.timeField && this._buildTimeIndexes(a), this.createLayers(a)
        },
        _buildQuery: function(a) {
            var b = this._service.query().within(a).where(this.options.where).fields(this.options.fields).precision(this.options.precision);
        ...
        setWhere: function(a) {
            ...
            for (var b = [], c = [], d = 0, e = L.Util.bind(function(a, e) {
                    if (e)
                        for (var f = e.features.length - 1; f >= 0; f--) c.push(e.features[f].id);
                    d--, 0 >= d && (this._currentSnapshot = c, this.removeLayers(b), this.addLayers(c))
                }, this), f = this._currentSnapshot.length - 1; f >= 0; f--) b.push(this._currentSnapshot[f]);
        ...
        setTimeRange: function(a, b) {
            ...
            if (this.options.from = a, this.options.to = b, this._filterExistingFeatures(c, d, a, b), "server" === this.options.timeFilterMode)
...
}(L), L.esri.Layers.FeatureLayer = L.esri.Layers.FeatureManager.extend({
    statics: {
        EVENTS: "click dblclick mouseover mouseout mousemove contextmenu popupopen popupclose"
    },
    initialize: function(a, b) {
        L.esri.Layers.FeatureManager.prototype.initialize.call(this, a, b), b = L.setOptions(this, b), this._layers = {}, this._leafletIds = {}, this._key = "c" + (1e9 * Math.random()).toString(36).replace(".", "_")
    },
    onAdd: function(a) {
    ...
    createLayers: function(a) {
        for (var b = a.length - 1; b >= 0; b--) {
            ...
            if (e && !this._map.hasLayer(e) && this._map.addLayer(e), e && e.setLatLngs) {
                var f = L.GeoJSON.geometryToLayer(d, this.options.pointToLayer, L.GeoJSON.coordsToLatLng, this.options);
                e.setLatLngs(f.getLatLngs())
            }
            e || (c = L.GeoJSON.geometryToLayer(d, this.options.pointToLayer, L.GeoJSON.coordsToLatLng, this.options), c.feature = d, c.defaultOptions = c.options, c._leaflet_id = this._key + "_" + d.id, this._leafletIds[c._leaflet_id] = d.id, c.on(L.esri.Layers.FeatureLayer.EVENTS, this._propagateEvent, this), this._popup && c.bindPopup && c.bindPopup(this._popup(c.feature, c)), this.options.onEachFeature && this.options.onEachFeature(c.feature, c), this._layers[c.feature.id] = c, this.resetStyle(c.feature.id), (!this.options.timeField || this.options.timeField && this._featureWithinTimeRange(d)) && this._map.addLayer(c))
        }
    },
    ...
    resetStyle: function(a) {
        ...
        return b && (b.options = b.defaultOptions, this.setFeatureStyle(b.feature.id, this.options.style)), this
    },
    setStyle: function(a) {
        return this.eachFeature(function(b) {
...
}), L.esri.FeatureLayer = L.esri.Layers.FeatureLayer, L.esri.Layers.featureLayer = function(a, b) {
